...
*&---------------------------------------------------------------------*
*& MODULE TC_9003_01_CHANGE_TC_ATTR OUTPUT
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
MODULE tc_9003_01_change_tc_attr OUTPUT.
  DESCRIBE TABLE po_plans LINES tc_9003_01-lines.
ENDMODULE.
...
*&---------------------------------------------------------------------*
*& MODULE TC_9004_01_CHANGE_TC_ATTR OUTPUT
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
MODULE tc_9004_01_change_tc_attr OUTPUT.
  DESCRIBE TABLE po_histories LINES tc_9004_01-lines.
ENDMODULE.
